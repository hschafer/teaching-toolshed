...
class EdStemReader(CSVReader):
    def __init__(self, fname, sid_col, score_col='feedback grade', sid_is_email=True, dummy_rows=0,
                 rename_index={}):
        super().__init__(fname, sid_col, score_col, sid_is_email=sid_is_email, dummy_rows=dummy_rows)
